                    ...
                    <div class="p-6 bg-gray-800 dark:bg-gray-800 space-y-6">
                        <div class="grid grid-cols-1">
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="size-10 mt-1 block w-full" required autocomplete="name" :value="old('name')" />
                                <x-input-error class="mt-2" :messages="$errors->get('name')" />

                                <x-input-label for="category" :value="__('Choose Category')" class="mt-3" />
                                <select id="categories" name="category_id"
                                    class="size-10 mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" autocomplete="selection" :value="old('category_id')">
                                ...
                                <x-input-error class="mt-2" :messages="$errors->get('category_id')" />
                                 ...
                                 <x-input-label for="payment_type_id" :value="__('Payment Type')" class="mt-3" />
                                <select id="payment_type_id" name="payment_type_id"
                                    class="size-10 mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                ...
                                <x-input-error class="mt-2" :messages="$errors->get('payment_type_id')" />   
                            ...
                            <div class="flex justify-between items-center mt-4">
                                ...
                                <button type="submit"
                                    class="bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl text-white shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-bold py-2 px-4 rounded">Add</button>
                            </div>
                        </div>
                    </div>
                </form>
