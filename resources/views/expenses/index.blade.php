                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative w-3/12">
                        <label for="Start date"
                            class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Start date</label>
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                        ...
                        <input
                            class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Start date..." type="datetime-local" id="start_date" name="start_date"
                            value="{{ request('start_date') }}">
                    </div>
                    <div class="relative w-3/12">
                        <label for="End date"
                            class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">End date</label>
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                    ...
                    <div class="relative w-3/12">
                        <label for="Category"
                            class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Category</label>
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                        ...
                        <select id="categories" name="category_id" class="form-control block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    ...
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 w-2/4">
                                <a
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        @elseif (request('sort_by') === 'price' && request('sort_order') === 'desc')
                                        @else
                                        @endif
                                        <svg class="w-4 h-4 ms-1 ml-1" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            ...
                            <th scope="col" class="px-6 py-3">
                                <a
                                    href="{{ route('expenses.index', ['sort_by' => 'created_at', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc']) }}">
                                    <div class="flex items-center">
                                        Created at
                                        @if (request('sort_by') === 'created_at' && request('sort_order') === 'asc')
                                        @elseif (request('sort_by') === 'created_at' && request('sort_order') ===
                                        'desc')
                                        @else
                                        @endif
                                        <svg class="w-4 h-4 ms-1 ml-1" aria-hidden="true"
